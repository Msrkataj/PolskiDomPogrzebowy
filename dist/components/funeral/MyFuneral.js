...
var _FuneralHomeMap = _interopRequireDefault(require("./FuneralHomeMap"));
var _mistrzCeremonii = _interopRequireDefault(require("../../../public/assets/images/mistrz-ceremonii.webp"));
...
function _arrayWithHoles(r) { if (Array.isArray(r)) return r; } // Poprawny import
var FuneralHomeDetails = function FuneralHomeDetails() {
  ...
  (0, _react.useEffect)(function () {
    var getFileUrl = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(basePath, fileName, extensions) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 13:
              ...
              if (_context.t0.code !== 'storage/object-not-found') {
                console.error("Error fetching file with extension .".concat(ext, ":"), _context.t0);
              }
            case 16:
              _context.next = 3;
              break;
            ...
            case 26:
              return _context.abrupt("return", _mistrzCeremonii["default"]);
            case 27:
            case "end":
      ...
      return function getFileUrl(_x, _x2, _x3) {
        return _ref.apply(this, arguments);
      };
    }();
    var fetchFuneralHomeDetails = /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var userId, userDocRef, docSnap, homeData, funeralHomeName, basePath, logoUrl, mainImageUrl, hallImageUrl, carImageUrl;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 8:
              ...
              basePath = "".concat(funeralHomeName);
              _context2.next = 15;
              return getFileUrl(basePath, 'logo/logo', ['png', 'jpg', 'jpeg', 'webp']);
            case 15:
              logoUrl = _context2.sent;
              _context2.next = 18;
              return getFileUrl(basePath, 'images/main', ['png', 'jpg', 'jpeg', 'webp']);
            case 18:
              mainImageUrl = _context2.sent;
              _context2.next = 21;
              return getFileUrl(basePath, 'images/hall', ['png', 'jpg', 'jpeg', 'webp']);
            case 21:
              hallImageUrl = _context2.sent;
              _context2.next = 24;
              return getFileUrl(basePath, 'images/car', ['png', 'jpg', 'jpeg', 'webp']);
            case 24:
              carImageUrl = _context2.sent;
              ...
              setSelectedImage(mainImageUrl || _mistrzCeremonii["default"]);
              _context2.next = 31;
              break;
            case 30:
            ...
            case 33:
              ...
              console.error('Error fetching Funeral home details:', _context2.t0);
            case 36:
            case "end":
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 5:
            userDocRef = (0, _firestore.doc)(_firebase.db, 'domyPogrzebowe', userId);
            _context3.next = 8;
            return (0, _firestore.updateDoc)(userDocRef, editableDetails);
          case 8:
          ...
          case 12:
            ...
            console.error('Error updating Funeral home details:', _context3.t0);
          case 15:
          case "end":
  ...
  var handleSaveServices = /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(updatedServices) {
      var userId, userDocRef;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          ...
          case 12:
            ...
            console.error('Error updating services:', _context4.t0);
          case 15:
          case "end":
    ...
    return function handleSaveServices(_x4) {
      return _ref4.apply(this, arguments);
    };
  }();
  if (!funeralHomeDetails) return /*#__PURE__*/_react["default"].createElement("div", {
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    className: "funeral-home-details-top"
    ...
    className: "funeral-home-details-settings"
  }, /*#__PURE__*/_react["default"].createElement(_link["default"], {
    className: "back-link settings-button",
    href: "/funeral/settings"
  }, "Ustawienia")), /*#__PURE__*/_react["default"].createElement("div", {
  ...
  }, "Dodaj kolejne godzinny otwarcia"), /*#__PURE__*/_react["default"].createElement("p", null, /*#__PURE__*/_react["default"].createElement("strong", null, "Telefon:"), isEditing ? /*#__PURE__*/_react["default"].createElement("input", {
    type: "tel",
  ...
  }, funeralHomeDetails.description))), isEditing && /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("button", {
    onClick: handleSave
  }, "Zapisz"), /*#__PURE__*/_react["default"].createElement("button", {
    onClick: handleCancel
