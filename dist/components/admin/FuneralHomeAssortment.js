...
var _AddAsortment = _interopRequireDefault(require("../funeral/AddAsortment"));
...
var FuneralHomeAssortment = function FuneralHomeAssortment() {
  ...
  var homeId = router.query.homeId;
  (0, _react.useEffect)(function () {
    var fetchAssortment = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var docRef, docSnap, data, fetchedAssortment, fetchedMusic, combinedAssortment;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              docRef = (0, _firestore.doc)(_firebase.db, 'domyPogrzebowe', homeId);
              _context.next = 6;
            ...
            case 6:
              ...
              if (docSnap.exists()) {
                ...
                fetchedMusic = data.music || []; // Jeśli 'music' nie jest tablicą, zamień na tablicę
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            if (!(originalEditItem.category !== editItem.category || originalEditItem.type !== editItem.type || originalEditItem.name !== editItem.name)) {
              _context2.next = 5;
              break;
            }
            _context2.next = 5;
            return moveProductFiles(originalEditItem, editItem);
          case 5:
          ...
          case 22:
            ...
            console.error('Błąd podczas zapisywania asortymentu:', _context2.t0);
          case 25:
          case "end":
  ...
  var moveProductFiles = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(oldProduct, newProduct) {
      var storage, updatedImageUrls, _iterator, _step, url, urlParts, fileNameWithParams, fileName, oldStoragePath, newStoragePath, oldRef, newRef, fileData, newUrl;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            updatedImageUrls = [];
            _iterator = _createForOfIteratorHelper(oldProduct.imageUrls);
            _context4.prev = 5;
            _iterator.s();
          case 7:
            ...
            url = _step.value;
            urlParts = url.split('/');
            fileNameWithParams = urlParts[urlParts.length - 1];
            fileName = fileNameWithParams.split('?')[0];
            oldStoragePath = oldProduct.type ? "assortment/".concat(oldProduct.category, "/").concat(oldProduct.type, "/").concat(oldProduct.name, "/").concat(fileName) : "assortment/".concat(oldProduct.category, "/").concat(oldProduct.name, "/").concat(fileName);
            ...
            _context4.prev = 16;
            _context4.next = 19;
            return (0, _storage.getDownloadURL)(oldRef).then(/*#__PURE__*/function () {
          ...
          case 19:
            ...
            _context4.next = 22;
            return (0, _storage.uploadBytes)(newRef, fileData);
          case 22:
            _context4.next = 24;
          ...
          case 30:
            ...
            console.error('Błąd podczas przenoszenia pliku:', _context4.t0);
          case 33:
            _context4.next = 7;
            break;
          case 35:
          ...
          case 43:
            setEditItem(function (prevEditItem) {
              return _objectSpread(_objectSpread({}, prevEditItem), {}, {
      ...
      }, _callee4, null, [[5, 37, 40, 43], [16, 30]]);
    }));
    return function moveProductFiles(_x2, _x3) {
  ...
  var handleImageAdd = /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(e) {
      var files, newImageUrls, storage, _iterator2, _step2, file, fileName, storagePath, fileRef, url;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            files = e.target.files;
            newImageUrls = _toConsumableArray(editItem.imageUrls || []);
            storage = (0, _storage.getStorage)();
          ...
          case 6:
            ...
            file = _step2.value;
            fileName = (0, _uuid.v4)() + "_" + file.name;
            storagePath = editItem.type ? "assortment/".concat(editItem.category, "/").concat(editItem.type, "/").concat(editItem.name, "/").concat(fileName) : "assortment/".concat(editItem.category, "/").concat(editItem.name, "/").concat(fileName);
            fileRef = (0, _storage.ref)(storage, storagePath);
            _context5.prev = 11;
            _context5.next = 14;
      ...
      }, _callee5, null, [[4, 27, 30, 33], [11, 20]]);
    }));
    return function handleImageAdd(_x5) {
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          ...
          case 11:
            ...
            console.error('Błąd podczas zapisywania asortymentu:', _context6.t0);
          case 14:
          case "end":
  ...
  var handleDeleteClick = /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(index) {
      var itemToDelete, updatedAssortment, docRef, newMusicArray;
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          ...
          case 17:
            ...
            console.error('Błąd podczas usuwania produktu:', _context7.t0);
          case 20:
          case "end":
    ...
    return function handleDeleteClick(_x6) {
  ...
  if (loading) {
    return /*#__PURE__*/_react["default"].createElement("p", null, "\u0141adowanie...");
  }
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    href: "/admin/funerals"
  }, "Wr\xF3\u0107 do dom\xF3w pogrzebowych"), /*#__PURE__*/_react["default"].createElement("h1", null, "Asortyment:"), /*#__PURE__*/_react["default"].createElement("div", {
  ...
  }, "Na zam\xF3wienie")), /*#__PURE__*/_react["default"].createElement("p", null, "Opis:"), /*#__PURE__*/_react["default"].createElement("input", {
    type: "text",
    value: editItem.text,
    onChange: function onChange(e) {
...
var FuneralHomeAssortmentWithAuth = function FuneralHomeAssortmentWithAuth() {
  return /*#__PURE__*/_react["default"].createElement(_AuthGuard["default"], null, /*#__PURE__*/_react["default"].createElement(FuneralHomeAssortment, null));
};
var _default = exports["default"] = FuneralHomeAssortmentWithAuth;