...
var FuneralHomeDetails = function FuneralHomeDetails() {
  ...
  (0, _react.useEffect)(function () {
    if (role) {
      ...
      if (!userRole || isNaN(loginTime) || currentTime - loginTime > ONE_DAY_MS) {
        ...
        console.log("User role does not match: requiredRole(".concat(role, ") !== userRole(").concat(userRole, ")"));
        router.push('/login');
      } else {
  ...
  (0, _react.useEffect)(function () {
    var fetchFuneralHomeDetails = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var userId, formDoc, formData, funeralHomeName, q, querySnapshot, homeData, logoUrl, mainImageUrl, hallImageUrl, carImageUrl;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 5:
              _context.prev = 5;
              _context.next = 8;
              return (0, _firestore.getDoc)((0, _firestore.doc)(_firebase.db, 'forms', userId));
            case 8:
              formDoc = _context.sent;
              if (!formDoc.exists()) {
                _context.next = 37;
                break;
              }
              formData = formDoc.data();
              funeralHomeName = formData.funeralHomeName; // Pobierz szczegóły domu pogrzebowego na podstawie nazwy
              q = (0, _firestore.query)((0, _firestore.collection)(_firebase.db, 'domyPogrzebowe'), (0, _firestore.where)('name', '==', funeralHomeName));
              _context.next = 15;
            ...
            case 15:
              ...
              homeData = querySnapshot.docs[0].data(); // Pobierz URL-e zdjęć z Firebase Storage
              _context.next = 20;
              return (0, _storage.getDownloadURL)((0, _storage.ref)(_firebase.storage, "".concat(homeData.name, "/logo/logo.png")));
            case 20:
              logoUrl = _context.sent;
              _context.next = 23;
              return (0, _storage.getDownloadURL)((0, _storage.ref)(_firebase.storage, "".concat(homeData.name, "/images/main.webp")));
            case 23:
              mainImageUrl = _context.sent;
              _context.next = 26;
              return (0, _storage.getDownloadURL)((0, _storage.ref)(_firebase.storage, "".concat(homeData.name, "/images/hall.webp")));
            case 26:
              hallImageUrl = _context.sent;
              _context.next = 29;
              return (0, _storage.getDownloadURL)((0, _storage.ref)(_firebase.storage, "".concat(homeData.name, "/images/car.webp")));
            case 29:
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    href: "/client/panel"
  }, "Cofnij"), /*#__PURE__*/_react["default"].createElement("h1", null, "Tw\xF3j wybrany dom pogrzebowy"), /*#__PURE__*/_react["default"].createElement("div", {
  ...
  }, /*#__PURE__*/_react["default"].createElement("h3", null, funeralHomeDetails.name), /*#__PURE__*/_react["default"].createElement("p", null, "Ocena: ", funeralHomeDetails.rating))), /*#__PURE__*/_react["default"].createElement("div", {
    className: "home-details-contact"
  }, /*#__PURE__*/_react["default"].createElement("p", null, /*#__PURE__*/_react["default"].createElement("strong", null, "Adres:"), " ", funeralHomeDetails.address), /*#__PURE__*/_react["default"].createElement("p", null, /*#__PURE__*/_react["default"].createElement("strong", null, "Godziny otwarcia:"), " ", funeralHomeDetails.hours), /*#__PURE__*/_react["default"].createElement("p", null, /*#__PURE__*/_react["default"].createElement("strong", null, "Email:"), " ", funeralHomeDetails.email), /*#__PURE__*/_react["default"].createElement("p", null, /*#__PURE__*/_react["default"].createElement("strong", null, "Telefon:"), " ", funeralHomeDetails.phone)), /*#__PURE__*/_react["default"].createElement("div", {
    className: "services"
  ...
  }))), /*#__PURE__*/_react["default"].createElement("p", null, "Opis:"), /*#__PURE__*/_react["default"].createElement("div", {
  ...
  }, funeralHomeDetails.reviews.length > 0 ? funeralHomeDetails.reviews.map(function (review, i) {
  ...
  }, funeralHomeDetails.name), /*#__PURE__*/_react["default"].createElement(_image["default"], {
...
var _default = exports["default"] = FuneralHomeDetails;