    ...
    if (req.method === 'POST') {
        ...
        try {
            ...
            if (querySnapshot.empty) {
                return res.status(404).json({ error: 'Dom pogrzebowy o podanym adresie e-mail nie istnieje.' });
            }
                    ...
                    <div style="font-family: Arial, sans-serif; color: #333;">
                        ...
                        <div style="padding: 20px; background-color: #fff; border: 1px solid #ddd; border-radius: 10px; margin: 20px;">
                            ...
                            <div style="text-align: center; margin: 20px 0;">
                                <a href="http://localhost:3000/reset-password?token=${resetToken}" style="background-color: #4CAF50; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-size: 16px;">
                                    Resetuj hasło
                                </a>
                            </div>
