                ...
                <div className="content-wrapper">
                    ...
                    <div className="ceremony-text">
                        ...
                        <p>
                            ...
                            Niezależnie od miejsca, w którym się znajdujesz, gwarantujemy usługi na najwyższym poziomie,
                            dostosowane do Twoich potrzeb i oczekiwań.
                        </p>
                        <p>
                        ...
                        <div className="info-options">
                            <div className={`info-option ${selectedOption === 'trumny' ? 'active' : ''}`}
                                ...
                                {selectedOption === 'trumny' &&
                                    <p>Oferujemy szeroki wybór trumien i urn dostosowanych do różnych preferencji i
                                        budżetów. Niezależnie od tego, czy szukasz czegoś tradycyjnego czy nowoczesnego,
                                        mamy odpowiednie opcje.</p>}
                            </div>
                            <div className={`info-option ${selectedOption === 'dekoracje' ? 'active' : ''}`}
                                 onClick={() => handleToggle('dekoracje')}>
                                <h3  >Dekoracje i dodatki:</h3>
                                <span className="plus">+</span>
                                {selectedOption === 'dekoracje' &&
                                    <p>Dostępne są różnorodne dekoracje i dodatki, które mogą być dostosowane do
                                        indywidualnych potrzeb i życzeń, aby stworzyć wyjątkową atmosferę
                                        ceremonii.</p>}
                            </div>
                            <div className={`info-option ${selectedOption === 'mistrz' ? 'active' : ''}`}
                                ...
                                <span className="plus">+</span>
                                {selectedOption === 'mistrz' &&
                                    <p>Nasi doświadczeni mistrzowie ceremonii są gotowi, aby prowadzić uroczystości z
                                        pełnym szacunkiem i profesjonalizmem, zapewniając godne pożegnanie dla Twoich
                                        bliskich.</p>}
                            </div>
                        </div>
                    </div>
