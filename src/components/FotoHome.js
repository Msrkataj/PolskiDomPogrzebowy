...
const FotoHome = ({handleOpenChat}) => {
    ...
    return (
        <div className="container">
            <section id="emotional-support" className="support-section flex-center">
                <div className="content-wrapper">
                    <div className="support-text">
                        <Image src={heartIcon} alt="Heart Icon" width={32} height={32} loading="lazy"/>
                ...
                <div id="customer-support" className="contact-options flex-center">
                    <h2>24/7 Obsługa klienta</h2>
                    <p className="option-main-p" >
                    ...
                    <div className="option-main flex-center">
